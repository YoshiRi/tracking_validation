...
def main(args):
    ...
    second_topic = args.second_topic
    tlim = args.tlim
    xlim = args.xlim
    ylim = args.ylim
    vlim = args.vlim
...
def parse_argument():
    ...
    parser.add_argument(
        ...
        type=str,
        default=DEFAULT_TOPIC,
        help="Name of the secondary topic",
    )
